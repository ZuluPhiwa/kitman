...
<div className='mx-12  hidden md:grid md:grid-cols-3 gap-8  py-16 px-4 '>
     ...
     <p className='py-4'>
        Shop for new and classic football shirts.
     </p>
...
<div className=' block md:hidden items-center uppercase'>
   ...
   <Link to="/kitman/about"><li className='m-4'>About</li> </Link> 
   <Link to="/kitman/contact"><li className='m-4'>Contact</li></Link> 
   <Link to='/kitman/cart'><li className='m-4'>Cart</li> </Link>  
